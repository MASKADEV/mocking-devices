...
public class WaterMeterController {
    ...
    private static final String ACCESS_TOKEN = "fuU2ro7no7ajQe3ViBjl";
    ...
    @Autowired
    public WaterMeterController() throws MqttException {
    ...
    private TemperatureReading generateAndSendTemperature() {
        ...
        String payload = String.format("{\"water\": %f}", temperature);
